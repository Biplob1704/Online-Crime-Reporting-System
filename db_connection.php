...
class database{
    ...
    public function insert($query){
        ...
        if($insert_row){
            header("location:userlogin.php?msg=".urlencode('data insert successfully'));
            exit();
        }
        else
        {
    ...
    public function update($query){
        ...
        if($update_row){
            header("location:userhome1.php?msg=".urlencode('data update successfully'));
            exit();
        }
        else
        {
    ...
    public function delete($query){
        ...
        if($delete_row){
            header("location:?msg=".urlencode('data delete successfully'));
            exit();
        }
        else
        {
