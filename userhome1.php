      ...
      <div class="container">
        <section id="banner">
        				<div class="inner split">
        					<section>
        						<h1 class="text-white text-center py-4">Welcome to Online Crime Reporting System</h1>
        					</section>
                  <br><br>
        					<section>
        				<p>		<p class="text-white"> Crime Reporting System is to develop a web-based program using which people can report crime online. It provides the facility of uploading images or videos of crime scenes to ensure that police may take action immediately. It also supplies the advice of missing persons, most wanted criminals and security tips for the awareness of people. Presently there is no online web application available to report crime online. In order to report any complains associated with crime, people have to contact closest police station. People of the specific city are not aware of crime related matters such as list of Most wanted criminals of their town, newest crime related news, missing persons of the area etc. People must view News Channels or Read News Paper for such offense related details. Thus, we can say that present platform is manual and does not supply all the information from 1 source..</p></p>
